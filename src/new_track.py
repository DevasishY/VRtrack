...
if __name__ == "__main__":
    ...
    main(
        dataset_name="MOT17-ALL",
        data_root_dir=working_dir+"/data",
        output_dir="data/outdir/mot17",
        write_images="pretty",
        seed=666,
        interpolate=False,
        verbose=True,
        ...
        obj_detect_checkpoint_file=working_dir + "/models/COCO_DETR/checkpoint_epoch_45.pth",
