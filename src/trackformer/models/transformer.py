...
from mmdet_custom.models.backbones.base import vrwkv
...
class Transformer(nn.Module):
    ...
    def __init__(
        ...
        """
        self.encoder = vrwkv.VRWKV(depth=num_encoder_layers, embed_dims=d_model)
    ...
    def forward(self, src, mask, query_embed, pos_embed, tgt=None, prev_frame=None):
        ...
        memory = (
            self.encoder(src, pos=pos_embed, patch_resolution=(h, w))[0]
            .flatten(2)
            .permute(2, 0, 1)
        )
        ...
        hs, hs_without_norm = self.decoder(
            tgt,
            memory,
